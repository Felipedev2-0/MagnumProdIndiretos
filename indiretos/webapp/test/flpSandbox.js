		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Formulário Produtos Indiretos",
									"targetURL": "#comdevmagnumindiretos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdevmagnumindiretos-display": {
								"semanticObject": "comdevmagnumindiretos",
								"action": "display",
								"description": "Formulário Produtos Indiretos",
								"title": "Formulário Produtos Indiretos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.devmagnum.indiretos",
									"url": sap.ui.require.toUrl("com/devmagnum/indiretos")
								}
							}
						}
					}
